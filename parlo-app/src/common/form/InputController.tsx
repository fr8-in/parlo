...
interface Props {
  ...
  hidden?: boolean
  /** Callback function to handle when a button / enter key is pressed. */
  handleOnKeyPress?:Function | any
  /** Type of Key event. */
  keyEvent?:"Enter"
  /**Set weather the field should be auto focused. */
  autoFocus?:boolean
}
...
export const InputController = (props: Props) => {
   ...
   * @description Function to handle when a button / enter button is pressed. Default enter button event is used , you can add other keys in the interface and use it.
   * @param event 
   */
  const handleKeyPress = (event: React.KeyboardEvent<HTMLInputElement>) => {
    if (event.key === keyEvent) {
      if(handleOnKeyPress)handleOnKeyPress()
    }
  }
  return (
    <Controller

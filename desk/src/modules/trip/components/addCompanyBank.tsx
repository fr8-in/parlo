...
const AddCompanyBank = (props: Props) => {
    const { onClose, bank_data, callBack, account_no } = props
    const initialForm = {
        account_no: '',
        ifsc_code: '',
        beneficinary: '',
    ...
    useEffect(() => {
        setForm({
            ...form, is_primary: !bank_data?.length, account_no })
    }, [])
    ...
    return (
        <div className="p-3 pt-0 gap-3 h-full">
            <div className="flex justify-between items-center h-16 gap-3 mb-4">
                <h5 className="font-bold">Add Company Bank</h5>

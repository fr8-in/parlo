...
const IndentTableContainer = (props: IndentListProps) => {
    ...
    const seriesFilter: Filter[] = filter.series_name?.length > 0 ? [['series', 'in', filter.series_name]] : []
    const customerFilter: Filter[] = filter.customer_name?.length > 0 ? [['customer', 'in', filter.customer_name]] : customerSearchFilter

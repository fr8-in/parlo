...
const AddLocation = (props: AddCustomerProps) => {
    const { onClose, callBack, name } = props
    const initialForm = {
        address_title: null,
        address_line1: null,
        city: null
    ...
    const onSubmit = async (value: any) => {
        await createDoc('Locations', value).then(
            (result: any) => {
    ...
    return (
        <div className="p-3 pt-0 gap-3 h-full">
            <div className="flex justify-between items-center h-16 gap-3 mb-4">
                <h5 className="font-bold">Add Location</h5>

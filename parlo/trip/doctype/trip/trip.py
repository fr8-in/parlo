...
#------------------------------
	def update_workflow(self):
		...
		elif ((self.assigned_at is not None and len(f'{self.assigned_at}') > 0 ) and (self.workflow_state != "Assigned")):
				frappe.db.set_value('Trip',self.name,'workflow_state','Assigned')
